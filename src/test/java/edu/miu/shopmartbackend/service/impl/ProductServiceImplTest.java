...
class ProductServiceImplTest {
    ...
    void testSaveProduct() {
        ...
        when(userRepo.getUserById(anyLong())).thenReturn(user1);
    ...
    void testSaveProduct2() {
        ...
        product.setSeller(user);
        when(productRepo.save((Product) any())).thenReturn(product);
        when(userRepo.getUserById(anyLong())).thenThrow(new RuntimeException());
        ...
        assertThrows(RuntimeException.class, () -> productServiceImpl.saveProduct(product1, 1L));
        verify(userRepo).getUserById(anyLong());
    }
    ...
    void testUpdateProduct() {
        ...
        when(productRepo.findById((Long) any())).thenReturn(ofResult);
        productServiceImpl
                .updateProduct(new ProductDto(1L, "Product Name", 10.0d, "The characteristics of someone or something"), 1L);
        verify(modelMapper).map((Object) any(), (Class<Product>) any());
        verify(productRepo).save((Product) any());
        verify(productRepo).findById((Long) any());
    }
    ...
    void testUpdateProduct2() {
        ...
        when(productRepo.findById((Long) any())).thenReturn(ofResult);
        assertThrows(RuntimeException.class, () -> productServiceImpl
                .updateProduct(new ProductDto(1L, "Product Name", 10.0d, "The characteristics of someone or something"), 1L));
        verify(modelMapper).map((Object) any(), (Class<Product>) any());
        verify(productRepo).save((Product) any());
        verify(productRepo).findById((Long) any());
